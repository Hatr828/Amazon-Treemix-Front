...
export const SearchDropdown: React.FC = () => {
    ...
    const categories = ["All Departments", "Arts & Crafts", "Baby", "Beauty & Personal Care", "Computers", "Home & Kitchen", "Men's Fasion", "Smart Home", "Sports & Outdoors", "Tools & Home Improvement", "Women's Fasion"];
    ...
    return (
        <div className="dropdownWrapper" ref={dropdownRef} style={{ position: 'relative', display: 'flex', height: '100%' }}>
