          ...
          <span className="headerIcon">
            ...
            >
              <g filter="url(#filter0_d_3398_5894)">
                <path
                  d="M14 2C8.47143 2 4 6.2255 4 11.45C4 15.7652 7.70687 21.3314 10.6068 25.0257C12.3666 27.2676 15.6333 27.2676 17.3932 25.0257C20.2931 21.3314 24 15.7652 24 11.45C24 6.2255 19.5286 2 14 2ZM14 14.825C12.0286 14.825 10.4286 13.313 10.4286 11.45C10.4286 9.587 12.0286 8.075 14 8.075C15.9714 8.075 17.5714 9.587 17.5714 11.45C17.5714 13.313 15.9714 14.825 14 14.825Z"
                  fill="white"
                />
              </g>
              <defs>
                <filter
                  id="filter0_d_3398_5894"
                  x="0"
                  y="0"
                  width="28"
                  height="32.707"
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_3398_5894"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_3398_5894"
                    result="shape"
                  />
                </filter>
              </defs>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="BackgroundImageFix"
                  result="effect1_dropShadow_1313_28600"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_1313_28600"
                  result="shape"
                />
              </filter>
              <filter
                id="filter1_d_1313_28600"
                x="0"
                y="9"
                width="40"
                height="13"
