...
export default function CustomService() {
    ...
    return (
        <div>
            <div className="div-customServ" style={{display:"flex", justifyContent:"center"}}>
                <div>
                    <div className="div-dear-text">We’re here to help, Name</div>
                    <span className="text-des-mob">We’ll walk you through fixing most things here, or connect you to someone if you need more help.</span>
