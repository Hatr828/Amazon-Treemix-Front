    ...
    const categories: Category[] = [
        {
            ...
            icon: "bi bi-cart icon"
        },
        {
            id: "international",
            title: "International shopping",
            icon: "bi bi-globe icon"
        },
        {
            id: "payment",
            title: "Payment",
            icon: "bi bi-credit-card icon"
        },
        {
            id: "login",
            title: "Login, address",
        ...
        },
        {
            ...
            icon: "bi bi-shield-lock icon"
        },
        {
            id: "gift",
            title: "Charges or gift cards",
            icon: "bi bi-gift icon"
        },
        {
            id: "prime",
            title: "Prime",
            icon: "bi bi-star icon"
        },
        {
            id: "membership",
        ...
        },
        {
            ...
            icon: "bi bi-question-circle icon"
        }
    ]
