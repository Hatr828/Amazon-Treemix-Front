...
import {
    ...
    ProductType,
    MoreToConsiderItem
} from "@/app/product_page/types/product_page_types";
...
export function ProductPage({ product }: { product: ProductType }) {
    ...
    const ratingArray: boolean[] = Array.from(
        { length: 5 },
        ...
        async function fetchReviews() {
            ...
            try {
                ...
                const res = await fetch(
                    `${BASE_URL}/api/products/${product.id}/reviews?pageSize=5`,
                    {
                        method: "GET",
                    }
                );
                ...
                const sortedTop = [...reviews].sort(
                    (a, b) => b.rating - a.rating
                );

                const sortedRecent = [...reviews].sort(
                    (a, b) =>
                        new Date(b.createdAt).getTime()
                        - new Date(a.createdAt).getTime()
                );

                setTopReviews(sortedTop);
                setRecentReviews(sortedRecent);
    ...
    return(
        <div>
            ...
            <div className="image_title_buy_container">
                ...
                <div className="images_container">
                    {product.images.map((image, index) => (
                        <div
                            key={"image-" + index}
                            className={
                                selectedItemMarker === index
                                    ? "image_wrapper selected_image_wrapper"
                                    : "image_wrapper"
                            }
                ...
                <div className="main_image_container">
                    <div className="main_image_zoom">
                        <img
                            src={
                                product.images?.[selectedItemMarker]?.url
                ...
                <div className="title_price_about_container">
                    ...
                    <div className="price_info">
                        ...
                        <p className="promo_text">
                            Pay $
                            {(product.price.current / 6).toFixed(2)}
                            /month for 6 months, interest-free upon approval
                            for the Amazon Rewards Visa Card.
                ...
                <div className="buy_container">
                    ...
                    <p className="shipping_text">
                        $47.21 Shipping & Import Fees Deposit to Ukraine
                        <a href="#"> Details</a>
                    </p>

                    <p className="delivery_text">
                        Delivery <strong>Thursday, February 17</strong>.
                        Order within <a href="#">31 mins</a>
                    </p>

                    <div className="location_row">
                        <img
                            src="/product_page/geomarker.svg"
                            alt="marker"
                            width={15}
                            height={15}
                        />
            ...
            <div className="offers_section">
                ...
                <div className="offer_row">
                    ...
                    <span style={{ alignContent: "center" }}>
                        ...
                        to save up to 10% with Business-only prices
                        and free shipping
                    </span>
                ...
                <div className="offer_row">
                    ...
                    <span style={{ alignContent: "center" }}>
                        ...
                        Get a $50 Amazon Gift Card instantly
                        upon approval for the Amazon Rewards Visa Card
                    </span>
            ...
            {product.fromTheManufacturer && (
                <ManufacturerBlock
                    content={product.fromTheManufacturer}
                />
            )}
                ...
                <div className="right-column">
                    ...
                    <section className="warranty-section">
                        ...
                        <p>
                            ...
                            <a href="#"> please click here</a> (PDF).
                        </p>
                    ...
                    <section className="feedback-section">
                        ...
                        <p>
                            Would you like to
                            <a href="#"> tell us about a lower price?</a>
                        </p>
            ...
            <section className="videos-section">
                ...
                <div className="carousel-container">
                    ...
                    <button className="nav-btn prev">
                        <img
                            src="/product_page/to_the_left.svg"
                            alt="prev"
                        />
                    </button>
                                ...
                                >
                                    ...
                                    <div className="video-info">
                                        ...
                                        <p className="video-title">
                                            {video.name || "Product Review"}
                                        </p>

                                        <span className="video-author-badge">
                                            {video.author || "User"}
                                        </span>
                    ...
                    <button className="nav-btn next">
                        <img
                            src="/product_page/to_the_right.svg"
                            alt="next"
                        />
                    </button>
            ...
            <section className="qa-section">
                ...
                {product.productQuestions && (
                    <AllQuestionsList
                        allQuestions={product.productQuestions}
                    />
                )}
            ...
            <section className="mentions-section">
                ...
                <div className="tags-container">
                    ...
                    {product.mentionTags && product.mentionTags.length > 0 ? (
